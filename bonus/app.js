...
const discountlist = document.getElementById("discount-item");

btnElement.addEventListener("click", function () {
  const selectvalue = discountlist.value;
  console.log(selectvalue);

  console.dir(kmElement);
  console.dir(discountlist);

  const km = parseInt(kmElement.value); //number
  const age = parseInt(discountlist.value); //number
